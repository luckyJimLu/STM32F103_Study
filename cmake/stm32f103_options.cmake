...
if(NOT EXISTS "${PROJECT_CONFIG_FILE}")
    if(PROJECT_CONFIG_FILE STREQUAL "${CMAKE_SOURCE_DIR}/.config")
        set(PROJECT_CONFIG_FILE
            "${CMAKE_SOURCE_DIR}/product/atk_elite_f103ze/configs/baremetal_defconfig")
        message(STATUS ">> [Kconfig] .config not found; using ALIENTEK Elite F103ZE bare-metal default")
    else()
